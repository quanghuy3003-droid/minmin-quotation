...
assert.match(source,/initApp\(\)\.then\(\(\)=>setTimeout\(\(\)=>window\.__minminApplyPendingWooImageOrder/,'Pending Woo image repairs must wait until app state and local credentials finish loading');
