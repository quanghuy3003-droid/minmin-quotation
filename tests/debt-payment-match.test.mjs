...
assert.match(candidates,/payment\.related_id&&!paymentHasInvoiceRef/,'Payments already linked to another invoice must be excluded');
...
assert.match(link,/payment\.related_id=String\(inv\.id\)/,'Debt matching must store exactly one invoice link');
