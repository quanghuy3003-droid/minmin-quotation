...
assert.match(source,/\.sheet thead th\{height:26px!important;overflow:hidden!important;box-shadow:0 -4px 0 #000\}/,'Black quotation header cells must extend four pixels upward without moving their content');
