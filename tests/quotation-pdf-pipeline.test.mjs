...
assert.match(source,/\.sheet thead th\{height:26px!important;overflow:hidden!important;box-shadow:0 -2px 0 #000\}/,'Black quotation header cells must extend two pixels upward without moving the table body');
