...
assert.match(source,/\.total-cell-content\{position:absolute;inset:0;display:flex!important[^}]*align-items:center!important/,'Total content must fill each cell and center vertically');
